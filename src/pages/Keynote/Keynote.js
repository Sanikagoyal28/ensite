...
import Moushmi from "../../assets/MoushmiMohanty.jpg"
    ...
    <>
      ...
      <div className="container my-5">
        ...
        <div className="KN-grid">
          <div>
            <div className="KN-container">
              <img src={Moushmi} className="" alt="keynote-img" />
              <p className="KN-text">
                <h3>Ms. Moushumi Mohanty</h3>
                <br />

                <b>Biography</b>:
                Ms. Moushumi Mohanty is the Senior Programme Manager, Clean Air and Sustainable Mobility Unit at the Centre for Science and Environment (CSE) in New Delhi. She brings extensive research experience in the economics of electric vehicle technology and policy, along with a deep understanding of the electric vehicle supply chain and its ecosystem.

                <br /><br />
                Previously, she was Associate Director of the Automotive Supplier and Hybrid and Electric Vehicle vertical at Standard & Poor Global, where she worked for close to a decade. Ms. Mohanty holds academic credentials from the University of Hyderabad and Columbia Business School in New York.
              </p>
            </div>
          </div>
        </div>
